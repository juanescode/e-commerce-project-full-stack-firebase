    ...
    <div className="flex flex-col gap-3 bg-white rounded-xl p-5 w-full md:w-[400px]">
      ...
      >
        <div className="flex flex-col gap-1">
          <label htmlFor="brand-name" className="text-sm text-gray-500">
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="admin-name" className="text-sm text-gray-500">
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="admin-email" className="text-sm text-gray-500">
