...
export default function Checkout({ productList }) {
  ...
  return (
    <section className="flex flex-col gap-3 md:flex-row">
      <section className="flex flex-col flex-1 gap-4 p-4 border rounded-xl">
      ...
      <div className="flex flex-col flex-1 gap-3">
        <section className="flex flex-col gap-3 p-4 border rounded-xl">
          ...
          <div className="flex items-center justify-between w-full p-2 font-semibold">
            <h1>Total</h1>
            <h1>$ {totalPrice}</h1>
          </div>
        </section>
